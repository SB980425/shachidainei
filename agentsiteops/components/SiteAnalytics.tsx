...
const pathViewEvents: Record<string, string[]> = {
  ...
  "/delivery-gate/": ["delivery_gate_alias_view"],
  ...
  "/reports/client-route-workflow/": ["client_route_workflow_view"],
  ...
  "/launch-kit/": ["launch_kit_view"],
  "/answers/validate-ai-service-offer-before-building/": ["answer_offer_validation_view"],
  "/answers/ai-service-route-vs-generic-chatgpt/": ["answer_route_vs_chatgpt_view"],
  "/answers/when-to-stop-an-ai-website-idea/": ["answer_stop_rule_view"],
  "/website-opportunity-audit/": ["launch_blueprint_legacy_view", "route_file_service_view"],
  "/pricing/": ["launch_blueprint_pricing_view", "route_file_pricing_view"],
  "/sample/": ["sample_route_file_view"],
  "/compare/": ["launch_blueprint_compare_view", "route_file_compare_view"],
