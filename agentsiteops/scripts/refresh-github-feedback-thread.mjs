...
const body = [
  ...
  "2. Does the Route Confidence Checker make the first route decision explainable enough?",
  "3. Does the USD 29 Fit Review solve a narrow enough first problem?",
  "4. Does the USD 99 Launch Blueprint justify its price from the visible sample?",
  "5. Would the buyer need implementation instead of advice?",
  "6. What trust, proof, or outcome gap would block payment?",
  "",
