...
const allowedEvents = new Set([
  ...
  "messy_project_route_file_example_view",
  ...
  "plan_copy_continue",
  "idea_risk_example_loaded",
  "idea_risk_report_copy",
  "idea_risk_continue_plan",
  "client_state_current_click",
  "client_state_next_click",
  "route_file_viewer_tab",
  "review_status_selected",
  "review_response_copy",
  "review_status_link_click",
