...
- Generated: 2026-06-18T02:20:04.921Z
- Status: pass
- Checks: 347
- Blockers: 0
- Warnings: 0
...
| site_routes | pass | 66 routes aligned |
| page_registry | pass | 66 routes aligned |
| page_review_actions | pass | 66 routes aligned |
...
| route_shape | pass | /idea-risk-test/ has canonical slash shape |
| route_index | pass | /idea-risk-test/ index flag is true |
| route_shape | pass | /plan/ has canonical slash shape |
| route_index | pass | /plan/ index flag is true |
| route_shape | pass | /how-it-works/ has canonical slash shape |
| route_index | pass | /how-it-works/ index flag is true |
| route_shape | pass | /scope/ has canonical slash shape |
| route_index | pass | /scope/ index flag is true |
| route_shape | pass | /execution/ has canonical slash shape |
| route_index | pass | /execution/ index flag is true |
...
| route_index | pass | /tools/website-opportunity-scorer/ index flag is true |
| route_shape | pass | /tools/ai-crawler-readiness/ has canonical slash shape |
...
| route_shape | pass | /examples/route-file-from-messy-project/ has canonical slash shape |
| route_index | pass | /examples/route-file-from-messy-project/ index flag is true |
...
| route_index | pass | /services/ai-website-opportunity-audit/ index flag is true |
| route_shape | pass | /tools/audit-scope-builder/ has canonical slash shape |
...
| route_index | pass | /templates/seo-repo-skeleton/ index flag is true |
| route_shape | pass | /checklists/ai-content-quality-gate/ has canonical slash shape |
| route_index | pass | /checklists/ai-content-quality-gate/ index flag is true |
| route_shape | pass | /checklists/programmatic-seo-gate/ has canonical slash shape |
| route_index | pass | /checklists/programmatic-seo-gate/ index flag is true |
| route_shape | pass | /checklists/gsc-bing-indexnow-launch/ has canonical slash shape |
...
| route_shape | pass | /checklists/route-file-delivery-gate/ has canonical slash shape |
| route_index | pass | /checklists/route-file-delivery-gate/ index flag is true |
...
| route_index | pass | /guides/indexnow-cloudflare-pages/ index flag is true |
| route_shape | pass | /guides/gsc-bing-sitemap-verification/ has canonical slash shape |
| route_index | pass | /guides/gsc-bing-sitemap-verification/ index flag is true |
| route_shape | pass | /guides/ai-citation-grounding-metrics/ has canonical slash shape |
| route_index | pass | /guides/ai-citation-grounding-metrics/ index flag is true |
| route_shape | pass | /guides/small-website-ai-visibility-metrics/ has canonical slash shape |
| route_index | pass | /guides/small-website-ai-visibility-metrics/ index flag is true |
| route_shape | pass | /evidence/ has canonical slash shape |
| route_index | pass | /evidence/ index flag is true |
| route_shape | pass | /reports/route-evidence-dashboard/ has canonical slash shape |
...
| route_shape | pass | /reports/agentsiteops-route-run/ has canonical slash shape |
| route_index | pass | /reports/agentsiteops-route-run/ index flag is true |
| route_shape | pass | /reports/client-route-workflow/ has canonical slash shape |
| route_index | pass | /reports/client-route-workflow/ index flag is true |
...
| route_index | pass | /templates/website-opportunity-scoring-template/ index flag is true |
| route_shape | pass | /methodology/website-opportunity-scoring/ has canonical slash shape |
| route_index | pass | /methodology/website-opportunity-scoring/ index flag is true |
| route_shape | pass | /methodology/route-selection/ has canonical slash shape |
...
| route_index | pass | /editorial-policy/ index flag is true |
| route_shape | pass | /privacy/ has canonical slash shape |
| route_index | pass | /privacy/ index flag is true |
| route_shape | pass | /disclosure/ has canonical slash shape |
...
| route_shape | pass | /starter-review/ has canonical slash shape |
| route_index | pass | /starter-review/ index flag is true |
...
| app_page | pass | /idea-risk-test/ app page exists |
| app_page | pass | /plan/ app page exists |
| app_page | pass | /how-it-works/ app page exists |
| app_page | pass | /scope/ app page exists |
| app_page | pass | /execution/ app page exists |
...
| app_page | pass | /examples/route-file-from-messy-project/ app page exists |
...
| app_page | pass | /checklists/route-file-delivery-gate/ app page exists |
...
| app_page | pass | /guides/ai-citation-grounding-metrics/ app page exists |
| app_page | pass | /guides/small-website-ai-visibility-metrics/ app page exists |
...
| app_page | pass | /reports/agentsiteops-route-run/ app page exists |
| app_page | pass | /reports/client-route-workflow/ app page exists |
...
| analytics_allowlist | pass | start_page_view is registered |
| analytics_allowlist | pass | idea_risk_test_view is registered |
| analytics_allowlist | pass | plan_studio_view is registered |
| analytics_allowlist | pass | how_it_works_view is registered |
| analytics_allowlist | pass | scope_lock_view is registered |
| analytics_allowlist | pass | execution_workbench_view is registered |
...
| analytics_allowlist | pass | messy_project_route_file_example_view is registered |
...
| analytics_allowlist | pass | indexnow_cloudflare_pages_view is registered |
| analytics_allowlist | pass | gsc_bing_sitemap_verification_view is registered |
| analytics_allowlist | pass | small_ai_visibility_metrics_view is registered |
| analytics_allowlist | pass | ai_metric_matrix_view is registered |
| analytics_allowlist | pass | review_window_view is registered |
| analytics_allowlist | pass | evidence_ledger_view is registered |
...
| analytics_allowlist | pass | agentsiteops_route_run_view is registered |
| analytics_allowlist | pass | client_route_workflow_view is registered |
...
| route_view_event | pass | /idea-risk-test/ has view event |
| route_view_event | pass | /plan/ has view event |
| route_view_event | pass | /how-it-works/ has view event |
| route_view_event | pass | /scope/ has view event |
| route_view_event | pass | /execution/ has view event |
...
| route_view_event | pass | /examples/route-file-from-messy-project/ has view event |
...
| route_view_event | pass | /checklists/route-file-delivery-gate/ has view event |
...
| route_view_event | pass | /guides/ai-citation-grounding-metrics/ has view event |
| route_view_event | pass | /guides/small-website-ai-visibility-metrics/ has view event |
...
| route_view_event | pass | /reports/agentsiteops-route-run/ has view event |
| route_view_event | pass | /reports/client-route-workflow/ has view event |
...
| growth_snapshot | pass | 66 routes aligned |
