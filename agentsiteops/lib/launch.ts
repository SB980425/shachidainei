...
export const intakeFields = [
  ...
  "Who you want to sell to and who you do not want to sell to.",
  "Whether you prefer service work, templates, software, consulting, or done-for-you setup.",
  "Your current website, portfolio, social profile, or public page if available.",
  "Weekly time available for delivery and outreach.",
  "Your target first price range.",
...
export const marketSignals = [
  {
    ...
    summary:
      "Semrush presents AI Search and traditional SEO as a combined visibility problem, which supports keeping technical SEO and answer structure in the site without selling rankings as a promise.",
    href: "https://www.semrush.com/blog/"
  },
  {
    title: "AI citations are not the same as brand demand",
    summary:
      "Semrush's June 2026 AI citation study warns that being cited does not always mean the brand is mentioned, so AgentSiteOps treats AI visibility as supporting evidence, not revenue validation.",
  ...
  {
    title: "Competitive analysis includes AI visibility",
    summary:
      "Semrush frames modern competitive analysis around how competitors attract, convince, and keep customers across expanded surfaces, including AI visibility.",
    href: "https://www.semrush.com/blog/competitive-analysis/"
  }
];
...
export const outreachTemplates = {
  english: [
    ...
    "You already know the tools. The hard part is packaging: what exactly to sell, who to pitch first, and how to explain it on one page. I made a 48-hour Blueprint for that. Want to see the sample?",
